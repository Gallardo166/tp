...
public class AddCustomerCommandParser implements Parser<AddCustomerCommand> {
    ...
    public AddCustomerCommand parse(String args) throws ParseException {
        ...
        Customer customer = createCustomer(argMultimap);

        return new AddCustomerCommand(customer);
    }

    private static Customer createCustomer(ArgumentMultimap argMultimap) throws ParseException {
        ...
        if (!tagList.contains(Customer.DEFAULT_TAG)) {
            tagList.add(Customer.DEFAULT_TAG);
        }

        return new Customer(name, phone, email, address, tagList);
    }
